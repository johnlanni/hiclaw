...
You can also let the AI tool submit the issue or PR directly. Install [GitHub CLI](https://cli.github.com/), authenticate with `gh auth login`, then add the [OpenClaw GitHub skill](https://github.com/openclaw/openclaw/blob/main/skills/github/SKILL.md) to your AI coding tool (Cursor, Claude Code, etc.). After that, just ask it to file the issue or open a PR based on its analysis.
